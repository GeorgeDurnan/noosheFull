 ...
 * 
 * Renders the static "About Us" content for the Nooshé bakery website.
 * Displays the brand story, mission, and images describing the fusion of Persian and British influences.
 */
export const About = () => {
    return (
        <div className={styles.about}>
            <div className={styles.wrapper}>
                <div className={styles.textwithwoman}>
                    <h3 className={styles.title}>At Nooshé, we bring a taste of Persian heritage to every bite. Born from a passion for sharing the rich flavours and warm hospitality of Iranian culture, Nooshé is a UK-based
